            ...
            <div className="flex gap-2 mb-4">
                {sizes.map(size => (
                    <button
                        ...
                        className={`flex-1 py-1.5 rounded-xl text-sm font-bold border transition-all ${selectedSize.label === size.label
            ...
            <button
                ...
                className={`w-full py-3.5 rounded-xl flex items-center justify-center gap-2 font-bold transition-all ${added
                    ...
                    : item.is_sold_out
                        ...
                        : 'bg-emerald-100 text-emerald-900 hover:bg-emerald-600 hover:text-white shadow-sm'
                    }`}
            >
